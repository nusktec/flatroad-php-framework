$(function () {
  ...
  QUnit.test('should activate element by tab id', function (assert) {
    ...
    $('<ul><li id="auth"/><li id="profile"/></ul>').appendTo('#qunit-fixture')
  ...
  QUnit.test('should activate element by tab id in ordered list', function (assert) {
    ...
    $('<ol><li id="auth"/><li id="profile"/></ol>').appendTo('#qunit-fixture')
  ...
  QUnit.test('should activate element by tab id in nav list', function (assert) {
    ...
    $('<nav><div id="auth"></div><div id="profile"></div></nav>').appendTo('#qunit-fixture')
  ...
  QUnit.test('should not fire shown when tab is already active', function (assert) {
    ...
    var tabsHTML = '<ul class="nav nav-tabs" role="tablist">' +
      '<li class="nav-item"><a href="#auth" class="nav-link active" role="tab">Home</a></li>' +
      '<li class="nav-item"><a href="#profile" class="nav-link" role="tab">Profile</a></li>' +
      '</ul>' +
      '<div class="tab-content">' +
      '<div class="tab-pane active" id="auth" role="tabpanel"></div>' +
  ...
  QUnit.test('selected tab should have aria-selected', function (assert) {
    ...
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li><a class="nav-item active" href="#auth" toggle="tab" aria-selected="true">Home</a></li>' +
  ...
  QUnit.test('selected tab should deactivate previous selected tab', function (assert) {
    assert.expect(2)
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li class="nav-item"><a class="nav-link active" href="#auth" data-toggle="tab">Home</a></li>' +
  ...
  QUnit.test('selected tab should deactivate previous selected link in dropdown', function (assert) {
    assert.expect(3)
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li class="nav-item"><a class="nav-link" href="#auth" data-toggle="tab">Home</a></li>' +
        '<li class="nav-item"><a class="nav-link" href="#profile" data-toggle="tab">Profile</a></li>' +
  ...
  QUnit.test('should not remove fade class if no active pane is present', function (assert) {
    ...
    var done = assert.async()
    var tabsHTML = '<ul class="nav nav-tabs" role="tablist">' +
      '<li class="nav-item"><a id="tab-auth" href="#auth" class="nav-link" data-toggle="tab" role="tab">Home</a></li>' +
      '<li class="nav-item"><a id="tab-profile" href="#profile" class="nav-link" data-toggle="tab" role="tab">Profile</a></li>' +
      '</ul>' +
      '<div class="tab-content">' +
      '<div class="tab-pane fade" id="auth" role="tabpanel"></div>' +
      ...
      .on('shown.bs.tab', function () {
        ...
        $('#tab-auth')
          .on('shown.bs.tab', function () {
            ...
            assert.ok($('#auth').hasClass('fade'))
            assert.ok($('#auth').hasClass('show'))
